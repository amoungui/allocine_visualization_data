...
dataframe = 'https://spiritualiteriteculturevodum.com/wp-content/uploads/2023/04/allocine_movies_brute.csv'
...
def app():
    ...
    ## figure n_5
    st.markdown('#### Generale Analysis of Notes and Distributions of Notes')
    st.write("\n\n\n")
...
#    st.pyplot(fig3)
    ...
    with middle_column_2:
        plt.title("Correlation and Hist of différentes notations between press and spec rating ")
        fig6_1 = sns.jointplot(data=allocine, x="spec_rating", y="press_rating", kind='hist')
        st.pyplot(fig6_1)
